...
def list_all_categories(url):
 # print "Started list_all_categories"
  links = []
  categories = ['Polos','Sport Shirts', 'Dress Shirts', 'Jackets & Outerwear', 'Sweaters', 'Sweatshirts & T-Shirts', 'Rugbys', 'Pants', 'Chinos', 'Jeans', 'Sport Coats', 'Suits', 'Formalwear', 'Shorts', 'Swim', 'Big & Tall', 'Underwear', 'Sleepwear & Robes', 'Socks']
  men = find_men(url)
...
def index_this_thang(url):
  ...
  for link in list:
    ...
    for page in product_pages:
      ...
      index.append([information[0], information [1], information[2], information[3], information[4]])
