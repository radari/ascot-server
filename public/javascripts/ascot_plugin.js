        ...
        $.ajax({
          ...
          success: function (json) {
            if (json && json.tags) {
              ...
              overlay.append('<div class="ascot_overlay_image_menu"><ul><li href="#"><img src="http://www.ascotproject.com/images/overlayOptions_share.png"></li><li><a href="http://www.ascotproject.com/look/' + ascotId + '"><img src="http://www.ascotproject.com/images/overlayOptions_shirt.png"></a></li></ul></div>');
